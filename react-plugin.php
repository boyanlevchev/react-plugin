<?php
/**
 * Plugin Name:     React Wizard
 * Description:     A plugin to help customers select a plan
 * Author:          Boyan Levchev
 * Text Domain:     react-plugin
 * Domain Path:     /pricing-wizard
 * Version:         0.1.0
 *
...
define('RP_PLUGIN_DIR_URL', plugin_dir_url( __FILE__ ) . 'wizard/');
...
function rp_load_plugin(){
  ...
  new RpLoadReactApp( 'wp_enqueue_scripts', '', false, '#react-wizard-container');
}
